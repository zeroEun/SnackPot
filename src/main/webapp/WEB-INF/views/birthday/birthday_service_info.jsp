    ...
    <form class="" action="">
        ...
        <div class="form-group">            
            <div class="form-check per_amount">
                <input class="form-check-input" type="radio" name="per_amount" id="per_amount1" value="10000" checked>
        ...
        <div class="form-group">            
            <div class="form-check sending_time">
                <input class="form-check-input" type="radio" name="sending_time" id="sending_time1" value="당일" checked>
        ...
        <div class="form-group">            
            <textarea class="form_control" cols="50" rows="5">선물 선택하시오</textarea>
        </div>
        <hr>
